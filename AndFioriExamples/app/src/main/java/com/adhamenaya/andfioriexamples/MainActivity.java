package com.adhamenaya.andfioriexamples;
...
import com.adhamenaya.andfiori.ui.visualization.microchart.AreaChart;
import com.adhamenaya.andfiori.ui.visualization.microchart.ChartData;
import com.adhamenaya.andfiori.ui.visualization.microchart.ColumnChart;
import com.adhamenaya.andfiori.ui.visualization.microchart.DeltaChart;
import com.adhamenaya.andfiori.ui.visualization.microchart.HarveyBallChart;
import com.adhamenaya.andfiori.ui.visualization.microchart.RadialChart;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        harveyBallChart3.setData(89);
        harveyBallChart3.setColor(Color.RED);
        frameLayout.addView(harveyBallChart3);

        // Delta ball chart
        DeltaChart deltaChart = new DeltaChart(getApplicationContext());
        deltaChart.setDimension(450, 150);
        deltaChart.setValues(-105, -98);
        deltaChart.setColor(Color.GREEN);
